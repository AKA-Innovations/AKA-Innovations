      ...
      <div className="container mx-auto px-6 lg:px-12 max-w-5xl text-slate-700 dark:text-slate-300">
        ...
        <div className="prose dark:prose-invert max-w-none space-y-10 text-slate-600 dark:text-slate-400 text-sm lg:text-base leading-relaxed">
          ...
          <div>
            ...
            <p>
              By hosting data in a unified database, an <strong>Online School ERP</strong> eliminates department silos, allowing parents, students, teachers, and administrators to access real-time records. The ultimate goal of a <strong>Student Information System</strong> (SIS) is to drive administrative efficiency, reduce operational errors, and improve communication across the school ecosystem.
            </p>
          </div>
          ...
          <div className="border-t border-slate-200 dark:border-white/[0.05] pt-10">
            ...
            <p>
              An <strong>AI Powered School ERP</strong> represents the next evolution. Initially, AI features focused primarily on descriptive analytics—providing principals with performance graphs, predicting student attendance drops, and summarizing report cards. While these insights were valuable, they still required administrators to manually execute the final action.
            </p>
          </div>
          ...
          <div className="border-t border-slate-200 dark:border-white/[0.05] pt-10">
            ...
            <p>
              For example, when a teacher says, <em>&quot;Mark attendance for Grade 8A&quot;</em>, the AI agent parses the request, checks the teacher&apos;s permissions, locates the class database, registers the attendance status, and triggers automated push alerts to the parents of absent students. This is not a chatbot placeholder; it is a secure workflow automation system that performs actual database writes.
            </p>
          </div>
          ...
          <div className="border-t border-slate-200 dark:border-white/[0.05] pt-10">
            ...
            <ul className="list-disc pl-6 space-y-2 mb-4">
              <li><strong>Reduced Administration Time:</strong> Tasks that previously required navigating multiple sub-menus and forms can now be executed in seconds using natural language commands.</li>
              <li><strong>Minimized Human Error:</strong> Automating conflict resolution for timetable scheduling and exam planning prevents double-booking rooms or invigilator staff.</li>
              <li><strong>Secure Chatbot Helper:</strong> Provides students a chatbot study companion restricted exclusively to teacher-uploaded study notes, avoiding the confusion of unverified resources.</li>
              <li><strong>Zero Training Hurdles:</strong> Because users interact with the system using natural language, staff require minimal training to get started. If they can send a chat message, they can manage school operations.</li>
              <li><strong>Secure & Audited Actions:</strong> Every AI action runs through a strict Role-Based Access Control (RBAC) validation process, ensuring no user can execute actions outside their assigned permissions.</li>
            </ul>
          </div>
