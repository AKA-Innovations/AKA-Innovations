...
const pageContent = {
  ...
  description:
    'Tailored dashboards for teachers, admins, and students — each built around their specific workflows, not a one-size-fits-all view.',
  floatingBadges: {
...
const tabs = [
  {
    ...
    features: [
      {
        icon: ClipboardList,
        label: 'Quick Attendance & Marks Entry',
        value: '2 min avg',
      },
      {
        icon: FileText,
        label: 'Homework & Material Uploads',
        value: '↑ 34%',
      },
      {
        icon: TrendingUp,
        label: 'Student Performance Tracking',
        value: 'Live',
      },
    ],
    dashboard: {
  ...
  },
  {
    ...
    features: [
      ...
      {
        icon: DollarSign,
        label: 'Fees, Transport & Config',
        value: '₹12.4L due',
      },
      {
        icon: PieChart,
        label: 'Institution-wide Reports',
        value: 'Real-time',
      },
    ],
    dashboard: {
  ...
  },
  {
    ...
    features: [
      {
        icon: Calendar,
        label: 'Timetable & Exam Schedule',
        value: 'Synced',
      },
      {
        icon: Bell,
        label: 'Homework & Due-Date Alerts',
        value: '3 due',
      },
      {
        icon: BarChart2,
        label: 'Marks & Progress Reports',
        value: 'Live',
      },
    ],
    dashboard: {
...
> = {
    ...
    dot: '#0EC98C',
    bg: 'rgba(14,201,140,0.10)',
    label: 'Done',
  },
  next: {
    dot: '#4F7EF7',
    bg: 'rgba(79,126,247,0.10)',
    label: 'Next',
  },
  later: {
    dot: '#AAB0C0',
    bg: 'rgba(170,176,192,0.10)',
    label: 'Later',
  },
  urgent: {
    dot: '#F7604F',
    bg: 'rgba(247,96,79,0.10)',
    label: 'Urgent',
  },
};
...
export default function DashboardHighlights() {
  ...
  return (
    <section className="relative py-28 bg-[#F0F2F8] dark:bg-[#0B1120] overflow-hidden transition-colors duration-300">
      {/* Ambient blobs */}
      <div className="pointer-events-none absolute inset-0 -z-10">
        <motion.div
          ...
          style={{
            background: `radial-gradient(ellipse at 30% 50%, ${accent}22 0%, transparent 70%)`,
          }}
        ...
        <motion.div
          ...
          className="absolute inset-0 bg-gradient-to-br from-transparent to-[#c5cfe8]/10 dark:to-slate-900/40"
        />
      </div>
          ...
          <div>
            <motion.div
              ...
              className="
                ...
                border border-[#DDE2EE] dark:border-slate-800
                shadow-sm
                text-xs font-semibold tracking-wide font-dm-sans
              "
              style={{ color: accent }}
            >
              <span
            ...
            <h2 className="text-4xl font-extrabold text-[#1C2237] dark:text-white mb-4 leading-tight font-dm-sans">
              {pageContent.heading.line1}
              <br />
              <span style={{ color: accent }}>
                {pageContent.heading.line2}
              </span>
            </h2>

            <p className="text-[#6B7492] dark:text-slate-400 mb-10 max-w-md leading-relaxed font-dm-sans">
            ...
            <div
              className="
                inline-flex gap-1 p-1 mb-10 rounded-2xl
                bg-white dark:bg-slate-900
                border border-[#DDE2EE] dark:border-slate-800
                shadow-sm
              "
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <h3 className="text-2xl font-bold text-[#1C2237] dark:text-white mb-3 font-dm-sans">
                  {current.title}
                </h3>

                <p className="text-[#6B7492] dark:text-slate-400 max-w-md mb-8 leading-relaxed font-dm-sans">
                  {current.description}
                </p>
                  ...
                  {current.features.map((f, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="text-[#1C2237] dark:text-white font-medium flex-1 font-dm-sans">
                          {f.label}
                        </span>

                        <span
                          className="text-xs font-bold px-3 py-1 rounded-full font-dm-sans"
                          style={{
            ...
            >
              ...
              <div
                className="
                  ...
                  dark:shadow-[0_40px_100px_-30px_rgba(0,0,0,0.5)]
                  overflow-hidden
                "
              >
                {/* Header */}
                <div
                  className="
                    ...
                    border-b border-[#F0F2F8] dark:border-slate-800
                  "
                  style={{
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-bold text-[#1C2237] dark:text-white font-dm-sans">
                      {dash.heading}
                    </span>
                  </div>
                ...
                <div className="p-6 space-y-5">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {dash.stats.map((s, i) => (
                      ...
                      >
                        <p
                          className="text-xs mb-1 font-dm-sans"
                          style={{
                            color:
                              i === 0
                        ...
                        <p
                          className="text-xl font-extrabold leading-none font-dm-sans"
                          style={{
                            color:
                              i === 0
                                ? '#fff'
                        ...
                        <p
                          className="text-[11px] mt-1 font-dm-sans"
                          style={{
                            color:
                              i === 0
                  ...
                  {/* List */}
                  <div className="bg-[#F6F8FC] dark:bg-slate-950 rounded-2xl p-4">
                    <p className="text-xs font-semibold text-[#6B7492] dark:text-slate-400 mb-3 uppercase tracking-wider">
                      {dash.list.title}
                    </p>
                        ...
                        return (
                          <motion.div
                            ...
                            className="
                              ...
                              border border-[#EEF0F7] dark:border-slate-800
                            "
                          >
                            <div className="flex items-center gap-2.5">
                              ...
                              <span className="text-sm font-medium text-[#1C2237] dark:text-white">
                                {item.name}
                              </span>
                            </div>

                            <div className="flex items-center gap-2">
                              <span className="text-xs text-[#AAB0C0] dark:text-slate-500">
                                {item.time}
                              </span>
                  ...
                  {/* Activity */}
                  <div>
                    <p className="text-xs font-semibold text-[#6B7492] dark:text-slate-400 mb-2.5 uppercase tracking-wider flex items-center gap-2">
                      ...
                      {dash.activity.map((a, i) => (
                        ...
                        >
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-[#1C2237] dark:text-slate-200">
                              {a.label}
                            </span>
                          </div>

                          <span className="text-[11px] text-[#AAB0C0] dark:text-slate-500">
                            {a.time}
                          </span>
                        </motion.div>
                      ))}
              ...
              >
                ...
                <div>
                  <p className="text-xs font-bold text-[#1C2237] dark:text-white font-dm-sans">
                    {pageContent.floatingBadges.topRight.title}
                  </p>

                  <p className="text-[11px] text-[#AAB0C0] dark:text-slate-400 font-dm-sans">
                    {pageContent.floatingBadges.topRight.subtitle}
                  </p>
                </div>
              </motion.div>
              ...
              >
                <div
                  className="w-8 h-8 rounded-xl flex items-center justify-center"
                  style={{
                    background: 'rgba(14,201,140,0.12)',
                  }}
                >
                ...
                <div>
                  <p className="text-xs font-bold text-[#1C2237] dark:text-white font-dm-sans">
                    {pageContent.floatingBadges.bottomLeft.title}
                  </p>

                  <p className="text-[11px] text-[#AAB0C0] dark:text-slate-400 font-dm-sans">
                    {pageContent.floatingBadges.bottomLeft.subtitle}
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <p className="text-xs font-semibold text-[#1C2237] dark:text-white font-dm-sans">
                  {pageContent.floatingBadges.midRight.title}
                </p>
              </motion.div>
            </motion.div>
          </AnimatePresence>
